...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210826_bfa636cd344370e68522_20210826035348_archive.zip';
	const ARCHIVE_SIZE		 = '75152236';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'bfa636c-26035348';
    const SECONDARY_PACKAGE_HASH = '9db7279-26035348';
	const VERSION			 = '1.4.2';
